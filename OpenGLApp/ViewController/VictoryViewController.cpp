...
GameResult VictoryViewController::main(GLFWwindow* window) {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // Render
        glClearColor(0.05f, 0.15f, 0.05f, 1.0f); // Dark green background
        ...
        // Title
        RenderText(shaderText, "LIVELLO COMPLETATO!", centerX - 350.0f * scale, centerY + 100.0f * scale, 1.8f * scale, glm::vec3(0.2f, 0.9f, 0.3f));

        // Congratulations
        RenderText(shaderText, "Complimenti!", centerX - 120.0f * scale, centerY + 10.0f * scale, 0.7f * scale, glm::vec3(0.9f, 0.9f, 0.9f));
